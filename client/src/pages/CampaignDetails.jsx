                ...
                {donators.length > 0 ? donators.map((item, index) => (
                  <div>
                    ...
                    justify-between items-center gap-4'>
                      ...
                      text-[#b2b3bd] leading-[26px] break-all'>{index + 1}. 
                      {item.donator}</p>
                      <p className='font-epilogue font-normal text-[16px]
          ...
          <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
            ...
            <div className='mt-[30px]'>
              <input 
                ...
                text-white text-[18px] leading-[30px] placeholder:text-[#4b5262]
                rounded-[10px]' 
                value={amount}
              ...
              <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                ...
                text-[#808191]'>Support the project for no reward, just
                  because it speaks to you.</p>
              </div>
